...
int MCplots(){
  ...
  TString sP6_SoftJets_HT54 = "HThistos/Groom_Aj_HT54_HTled_TrueMB_NoEff_GeantMc.root";
  TString sP6_HardJets_HT54 = "HThistos/Groom_Aj_TrueMB_NoEff_GeantMc.root";
  if (UseAbove25){
    sP6_SoftJets_MB   = "HThistos/Above25_Groom_Aj_TrueMB_NoEff_GeantMc.root";
    sP6_SoftJets_HT54 = "HThistos/Above25_Groom_Aj_HT54_HTled_TrueMB_NoEff_GeantMc.root";
    sP6_HardJets_HT54 = "HThistos/Above25_Groom_Aj_TrueMB_NoEff_GeantMc.root";
  }    
  ...
  if ( Do_NS_SoftJets_MB && Do_AS_SoftJets_MB ){
    for (int i=0; i<AS_P6_SoftJets_MB->GetEntries(); ++i ){
      ...
      plotname = plotpath+"SoftJets_MB_"+plotname;
  ...
  if ( Do_NS_SoftJets_HT54 && Do_AS_SoftJets_HT54 ){
    for (int i=0; i<AS_P6_SoftJets_HT54->GetEntries(); ++i ){
      ...
      TString plotname = h6NS->GetName();
      plotname = plotname(plotname.Length()-5, plotname.Length());
      plotname = plotpath+"SoftJets_HT54_"+plotname;
      gPad->SaveAs(plotname+".png");
  ...
  if ( Do_NS_HardJets_HT54 && Do_AS_HardJets_HT54 ){
    for (int i=0; i<AS_P6_HardJets_HT54->GetEntries(); ++i ){
      ...
      TString plotname = h6NS->GetName();
      plotname = plotname(plotname.Length()-5, plotname.Length());
      plotname = plotpath+"HardJets_HT54_"+plotname;
      gPad->SaveAs(plotname+".png");
