...
#ifndef __FLEXAJANALYSIS_HH
#define __FLEXAJANALYSIS_HH
...
private :
  ...
  double PtConsLead;     ///< constituent p<SUB>T</SUB> cut for finding leading jet
  double PtConsSubLead;  ///< constituent p<SUB>T</SUB> cut for finding subleading jet
  ...
  fastjet::Selector select_hiptlead;        ///< constituent p<SUB>T</SUB> selector
  fastjet::Selector select_hiptsublead;        ///< constituent p<SUB>T</SUB> selector

  fastjet::Selector slo;                ///< compound selector for low  p<SUB>T</SUB> constituents
  fastjet::Selector shilead;            ///< compound selector for high p<SUB>T</SUB> constituents
  fastjet::Selector shisublead;         ///< compound selector for high p<SUB>T</SUB> constituents
...
// Relevant jet candidates
  ...
  JetAnalyzer* pJAhilead;                  ///< JetAnalyzer object for leading jet
  JetAnalyzer* pJAhisublead;               ///< JetAnalyzer object for subleading jet
  ...
  std::vector<fastjet::PseudoJet> pHilead;     ///< High pT constituents for leading jets
  std::vector<fastjet::PseudoJet> pHisublead;  ///< High pT constituents for subleading jets
  std::vector<fastjet::PseudoJet> pLo;         ///< Low pT constituents

  std::vector<fastjet::PseudoJet> JAhileadResult;      ///< Unaltered clustering result with high pT constituents for leading jets
  std::vector<fastjet::PseudoJet> JAhisubleadResult;   ///< Unaltered clustering result with high pT constituents for subleading jets
...
public:
   ...
   */
  FlexAjAnalysis ( double R = 0.4,
		   double jet_ptmin = 10.0, double jet_ptmax = 100.0,
		   double LeadPtMin = 20.0, double SubLeadPtMin = 10, 
		   double max_track_rap = 1.0, double PtConsLo=0.2,
		   double PtConsLead=2.0, double PtConsSubLead=1.0,
		   double dPhiCut = 0.4,
  ...
  inline fastjet::Selector& GetHiConsLeadSelector () { return shilead; }
  inline fastjet::Selector& GetHiConsSubLeadSelector () { return shisublead; }
  ...
  inline JetAnalyzer* GetJAhilead() {return pJAhilead; };
  inline JetAnalyzer* GetJAhisublead() {return pJAhisublead; };
  ...
  inline std::vector<fastjet::PseudoJet> GetJAhiLeadResult() {return JAhileadResult; };
  inline std::vector<fastjet::PseudoJet> GetJAhiSubLeadResult() {return JAhisubleadResult; };
  ...
  inline std::vector<fastjet::PseudoJet> GetHiLeadConstituents() {return pHilead; };
  inline std::vector<fastjet::PseudoJet> GetHiSubLeadConstituents() {return pHisublead; };
