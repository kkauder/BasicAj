...
namespace AjParameters{
  ...
  // choose the following in the calling program instead
  ...
  const double VzDiffCut=1000;      ///< |Vz(TPC) - Vz(VPD)| <-- NOT WORKING in older data
  ...
  // const double MaxTrackPt=30;       ///< track pT cut
  // const double MaxEtCut=50;         ///< tower ET cut
  // const double MaxTrackPt=1000;     ///< track pT cut
