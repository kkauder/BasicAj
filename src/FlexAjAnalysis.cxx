...
// Standard ctor
FlexAjAnalysis::FlexAjAnalysis ( double R,
				 double jet_ptmin, double jet_ptmax,
				 double LeadPtMin, double SubLeadPtMin, 
				 double max_track_rap, double PtConsLo,
				 double PtConsLead, double PtConsSubLead,
				 double dPhiCut, bool SubtractSoftBg
			 )
  : R(R),
    jet_ptmin(jet_ptmin), jet_ptmax(jet_ptmax),
    LeadPtMin(LeadPtMin), SubLeadPtMin(SubLeadPtMin),
    max_track_rap (max_track_rap), PtConsLo (PtConsLo),
    PtConsLead( PtConsLead ), PtConsSubLead ( PtConsSubLead ),
    dPhiCut (dPhiCut),
    pJAhilead (0), pJAhisublead (0), pJAlo(0), pOtherJAlo(0), SubtractSoftBg(SubtractSoftBg)
{
  ...
  shilead     = select_track_rap * select_hiptlead * select_track_charge;
  shisublead     = select_track_rap * select_hiptsublead * select_track_charge;
...
// ====================
int FlexAjAnalysis::AnalyzeAndFill ( std::vector<fastjet::PseudoJet>& particles, fastjet::PseudoJet* ToMatch,
  ...
  if (pJAhilead){    delete pJAhilead;    pJAhilead=0;  }
  if (pJAhisublead){    delete pJAhisublead;    pJAhisublead=0;  }
