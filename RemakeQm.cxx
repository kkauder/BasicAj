...
void RemakeQm() {
  ...
  // // // TFile *fAuAu         = TFile::Open("AjResults/R0.2_HP_Clean.root");
  // // TFile *fAuAu         = TFile::Open("AjResults/R0.2_HP_Presel_AuAuAj.root");
  // // TFile *fppInAuAu     = TFile::Open("AjResults/Tow0_Eff0_R0.2_HP_ppInAuAuAj.root");
  // // TFile *fSyst         = TFile::Open("AjResults/R0.2_HP_Systematics_ppInAuAuAj.root");
  ...
  // // TFile *fAuAu         = TFile::Open("AjResults/Run11_TEST.root");
  // // TFile *fAuAu         = TFile::Open("AjResults/VroniTest.root");
  // // TFile *fAuAu         = TFile::Open("AjResults/NPE25_TEST.root");
  TFile *fAuAu         = TFile::Open("AjResults/rndm1/HP_TEST.root");
  ...
  if (TString(fAuAu->GetName()).Contains("R0.2") ){
    gPad->SaveAs("plots/R0.2_HP_Part1.png");
  } else if (TString(fAuAu->GetName()).Contains("Pt1") ){
    gPad->SaveAs("plots/Pt1_HP_Part1.png");
  } else {
    gPad->SaveAs("plots/R0.4_HP_Part1.png");
  }
  ...
  if (TString(fAuAu->GetName()).Contains("R0.2") ){
    ...
    gPad->SaveAs("plots/R0.2_HP_Fig.png");
    gPad->SaveAs("plots/R0.2_HP_Fig.pdf");
  } else if (TString(fAuAu->GetName()).Contains("Pt1") ){
    gPad->SaveAs("plots/Pt1_HP_Fig1.png");
    gPad->SaveAs("plots/Pt1_HP_Fig1.pdf");
  } else {
    ...
    latex.SetTextColor( AuAuAJ_lo->GetLineColor() );
    latex.DrawLatex( .6,.45, plabel);
    gPad->SaveAs("plots/R0.4_HP_Fig1.png");
    gPad->SaveAs("plots/R0.4_HP_Fig1.pdf");
  }
