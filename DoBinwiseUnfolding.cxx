...
int DoBinwiseUnfolding( 
  ...
  RooUnfoldBinByBin    PtBinByBinUnfold ( LeadPtResponse, PtTestMeas);
  TH1D* PtBinByBinUnfolded= (TH1D*) PtBinByBinUnfold.Hreco();
  PtBinByBinUnfolded->SetName("PtBinByBinUnfolded");

  
  RooUnfoldResponse* LeadPtZgResponse2D = (RooUnfoldResponse*) ftrain->Get("LeadPtZgResponse2D");
  RooUnfoldBinByBin    BinByBinUnfold ( LeadPtZgResponse2D, TestMeas2D);
  BinByBinUnfold.SetVerbose(1);
  TH2D* BinByBinUnfolded= (TH2D*) BinByBinUnfold.Hreco();


  // Output
  // ------
  TString OutFileName = "HThistos/BinwiseUnfolded_";
  OutFileName += gSystem->BaseName(trainname);
  TFile* fout = new TFile( OutFileName, "RECREATE");

  TString PlotBase = "HTplots/BinwiseUnfolded_";
  ...
  TH1D* unfoldpt = (TH1D*) BinByBinUnfolded->ProjectionX("unfoldpt");
  ...
  PtBinByBinUnfolded->SetLineColor(kGray+1);
  PtBinByBinUnfolded->Draw("same");
  leg->AddEntry("PtBinByBinUnfolded", "1D Unfolded");    
  ...
  TH1D* unfold0 = (TH1D*) BinByBinUnfolded->ProjectionY("unfold0", BinByBinUnfolded->GetXaxis()->FindBin( 10+0.01), BinByBinUnfolded->GetXaxis()->FindBin( 20-0.01));
  ...
  TH1D* unfold1 = (TH1D*) BinByBinUnfolded->ProjectionY("unfold1", BinByBinUnfolded->GetXaxis()->FindBin( 20+0.01), BinByBinUnfolded->GetXaxis()->FindBin( 30-0.01));
  ...
  TH1D* unfold2 = (TH1D*) BinByBinUnfolded->ProjectionY("unfold2", BinByBinUnfolded->GetXaxis()->FindBin( 30+0.01), BinByBinUnfolded->GetXaxis()->FindBin( 40-0.01));
  ...
  if (false){
    ...
    TH1D* ratiopt1d = (TH1D*) PtBinByBinUnfolded->Clone("ratiopt1d");
