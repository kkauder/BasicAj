...
void MakeFollowPlot() {
  ...
  if (TString(fAuAu->GetName()).Contains("R0.2") ){
    ...
    AuAuOtherAJ_lo->SetLineColor( kGreen+1 );
    AuAuOtherAJ_lo->SetMarkerColor( kGreen+1 );
    ppInAuAuOtherAJ_lo->SetLineColor( kGreen+1 );
    ppInAuAuOtherAJ_lo->SetMarkerColor( kGreen+1 );
  }
  ...
  if (TString(fAuAu->GetName()).Contains("R0.2") ){
    gPad->SaveAs("plots/R0.2_FollowUp_Part1.png");
  } else {
    gPad->SaveAs("plots/FollowDown_Part1.png");
  }
  ...
  if (TString(fAuAu->GetName()).Contains("R0.2") ){
    gPad->SaveAs("plots/R0.2_FollowUp_Fig.png");
  } else {
    gPad->SaveAs("plots/FollowDown_Fig.png");
  }
