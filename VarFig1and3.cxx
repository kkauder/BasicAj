...
int VarFig1and3( TString R = "" ) {
  ...
  TH1D* AuAuAJ_hi=0;
  if ( nofabs ){
    AuAuAJ_hi = (TH1D*) ( (TH2D*) fAuAu->Get( "NoFabsAJ_hi") )->ProjectionX("AuAuAJ_hi", AuAuMultBinL, AuAuMultBinR);
    AuAuAJ_lo = (TH1D*) ( (TH2D*) fAuAu->Get( "NoFabsAJ_lo") )->ProjectionX("AuAuAJ_lo", AuAuMultBinL, AuAuMultBinR);
  } else {
    AuAuAJ_hi = (TH1D*) ( (TH2D*) fAuAu->Get( "AJ_hi") )->ProjectionX("AuAuAJ_hi", AuAuMultBinL, AuAuMultBinR);
    AuAuAJ_lo = (TH1D*) ( (TH2D*) fAuAu->Get( "AJ_lo") )->ProjectionX("AuAuAJ_lo", AuAuMultBinL, AuAuMultBinR);
  }
  TH1D* ppInAuAuAJ_hi=0;
  TH1D* ppInAuAuAJ_lo=0;
  if ( nofabs ) {
    ppInAuAuAJ_hi = (TH1D*) ( (TH2D*) fppInAuAu->Get( "NoFabsAJ_hi") )->ProjectionX("ppInAuAuAJ_hi", AuAuMultBinL, AuAuMultBinR);
    ppInAuAuAJ_lo = (TH1D*) ( (TH2D*) fppInAuAu->Get( "NoFabsAJ_lo") )->ProjectionX("ppInAuAuAJ_lo", AuAuMultBinL, AuAuMultBinR);
  } else {
    ppInAuAuAJ_hi = (TH1D*) ( (TH2D*) fppInAuAu->Get( "AJ_hi") )->ProjectionX("ppInAuAuAJ_hi", AuAuMultBinL, AuAuMultBinR);
  ...
  if ( fSyst ){
    ...
    if ( nofabs ) Tpar=(TParameter<double>*) fSyst->Get("KS_NoFabsNominalE_Hi");
    else Tpar=(TParameter<double>*) fSyst->Get("KS_NominalE_Hi");
  ...
  // // p-value systematics
  // if ( nofabs ){
  //   Tpar=(TParameter<double>*) fSyst->Get("KS_NoFabsPlusE_Hi");
  //   KS_PlusE_Hi = Tpar->GetVal();
  //   Tpar=(TParameter<double>*) fSyst->Get("KS_NoFabsMinusE_Hi");
  //   KS_MinusE_Hi = Tpar->GetVal();
  //   Tpar=(TParameter<double>*) fSyst->Get("KS_NoFabsPlusT_Hi");
  //   KS_PlusT_Hi = Tpar->GetVal();
  //   Tpar=(TParameter<double>*) fSyst->Get("KS_NoFabsMinusT_Hi");
  ...
  cout << "p-value E, hi:  	"  << KS_NominalE_Hi << endl;
  cout << "p-value T, hi:  	"  << KS_NominalE_Hi << endl;


  cout << "p-value E, lo:  	"  << KS_NominalE_Lo << endl;
  cout << "p-value T, lo:  	"  << KS_NominalE_Lo << endl;
