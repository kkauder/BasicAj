bool GeantWeightReject ( const double R, const double pt, const double weight, const int type ){
  ...
  // type:
  // MC: 0 for trigger, 1 for recoil.
  // RECO: 10 for trigger, 11 for recoil.
