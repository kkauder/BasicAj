...
foreach Tow ( -1 0 1 )
	...
	set In  = AjResults/Tow${Tow}_Eff${Eff}_${RMod}SoftDropped_Fresh_NicksList_HC100_ppInAuAuAj_*.root
	set Out = AjResults/Tow${Tow}_Eff${Eff}_${RMod}SoftDropped_Fresh_NicksList_HC100_ppInAuAuAj.root
	hadd -f ${Out} ${In}
    end
end
