...
void HPPtPlot() {
  ...
  TFile *fPt1AuAu         = TFile::Open("AjResults/Pt1_HP_Presel_AuAuAj.root");
  TFile *fPt1ppInAuAu     = TFile::Open("AjResults/Tow0_Eff0_Pt1_HP_ppInAuAuAj.root");
  TFile *fPt1Syst         = TFile::Open("AjResults/Pt1_HP_Systematics_ppInAuAuAj.root");
  ...
  ppInAuAuAJ_hi->SetAxisRange( 0,0.22,"y");
  ppInAuAuAJ_hi->GetYaxis()->SetTitleOffset(1.14);
  ppInAuAuAJ_hi->SetTitle(";|A_{J}|;Event Fraction");
  ...
  cerr << "OLD: Kolmogorov-Smirnov for pp @ AuAu vs. AuAu, MEDIUM cut: " << Pt1ppInAuAuAJ_lo->KolmogorovTest(Pt1AuAuAJ_lo, "") << endl;
  cerr << "OLD: chi^2 test for pp @ AuAu vs. AuAu, MEDIUM cut: " << Pt1ppInAuAuAJ_lo->Chi2Test(Pt1AuAuAJ_lo, "") << endl;
